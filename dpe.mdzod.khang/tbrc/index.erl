[ { cat, "CANON", "", '/', [
        ...
        { pub,  'Tengyur Dege', 213, "bstan 'gyur (sde dge)", '/',
                "The Derge edition of the Tengyur, edited by Zhuchen Tsultrim Rinchen (1697-1774),"
                "was a masterpiece of scholarship. The Tengyur is a collection of basic texts"
                ...
                "added later.",
                [ { ver, 'W23703', "1317-1518,1521-1531" } ] },

        { pub,  'Nyingma Gyubum Tsamdrak', 46, "rnying ma rgyud 'bum (mtshams brag)", '/',
                ...
                "manuscript was subsequently reprinted in Chengdu and has thus spread throughout China.",
                [ { ver, 'W21521', "604-649" } ] },

        { pub,  'Kangyur Stog Palace', 109, "bka' 'gyur (stog palace bris ma)", '/',
                ...
                "for textual studies.",
                [ { ver, 'W22083', "3708-3816" } ] },

        { pub,  'Nyingma Gyubum Tingkye', 36, "rnying ma rgyud 'bum (gting skyes dgon pa byang bris ma)", '/',
                ...
                [ { ver, 'W21518', "1719,1751,1757-1790" } ] },

        { pub,  'Nyingma Gyubum Kakong', 6, "rnying ma rgyud 'bum gyi kha skong (mtshams brag dgon pa'i bris ma)", '/',
                "Supplementary volumes of tantras of the Nyingma tradition recently found in China.",
                [ { ver, 'W25815', "3900-3905" } ] },

        { pub,  'Bairo Gyubum', 8, "bai ro'i rgyud 'bum", '/',
...
{ cat, "NYINGMA", "", '/', [
        ...
        { pub,  'Ranrig Dorje Tercho', 42, "nyag bla rang rig rdo rje'i gter chos", '/',
                ...
                [ { ver, 'W1PD289', "I1PD291-I1PD332" } ] },

        { pub,  'Jigme Puntsok Jungne', 4, "gser rta mkhan po 'jigs med phun tshogs kyi gsung 'bum", '/',
                ...
                [ { ver, 'W00KG03976', "I00KG03978-I00KG03980" },
                  { ver, 'W1PD95698', "I1PD95700-I1PD95703" } ] },

        { pub,  'Osal Dorje Sandzo', 1, "od gsal rdo rje gsang mdzod", '/',
                ...
                [ { ver, 'W19666', "I1KG21985" },
                  { ver, 'W8LS16492', "" } ] },

        { pub,  'Dorje Dradul', 1, "dge ba'i bshes gnyen chen mo rdo rje dgra 'dul gyi gsung pad+ma dkar po'i do shal", '/',
                "",
                [ { ver, 'W2DB19541', "I1PD34857" } ] },

        { pub,  'Sogyal Lerab Lingpa', 17, "las rab gling pa'i gter chos", '/',
                "Revelations by terton Lerab Lingpa otherwise known as, Tulku Sogyal (1856-1926) of Nyagrong.",
                [ { ver, 'W21810', "1940-1954,2041" } ] },

        { pub,  'Drodul Garwang Lingpa', 8, "'gro 'dul gar dbang gling pa gter chos", '/',
                "Revelations by Drodul Garwang Lingpa (1856-1926).",
                [ { ver, 'W29031', "5006-5013" } ] },

        { pub,  'Nyakla Pema Dudul', 5, "nyag bla pad+ma bdud 'dul gyi gter chos skor", '/',
                "Revelations by the Nyingma terton Nyarong Pema Dudul (1816-1872).",
                [ { ver, 'W23695', "0796-0800" } ] },

        { pub,  'Tersar Chodzo Chenmo', 388, "gter gsar chos mdzod chen mo", '/',
                ...
                [ { ver, 'W2PD16917', "I3PD472-I3PD859" } ] },

        { pub,  'Longchen Nyingthig Triyik', 1, "klong chen snying thig gi khrid yig", '/',
        ...
        { pub,  'Rinchen Terdzo Chenmo', 111, "rin chen gter mdzod chen mo", '/',
                ...
                [ { ver, 'W20578', "0001-0111" } ] },

        { pub,  'Dorje Dechen Lingpa Tercho', 11, "rdo rje bde chen gling pa gter chos", '/',
        ...
        { pub,  'Yeshes Jungnas Tercho', 8, "sgo 'dzin gter ston ye shes 'byung gnas kyi gter chos", '/',
        ...
        { pub,  'Sera Khandro Tercho', 4, "se ra mkha' 'gro kun bzang bde skyong dbang mo", '/',
                ...
                [ { ver, 'W21888', "1983-1986" } ] },

        { pub,  'Sera Khandro Sunbum', 6, "se ra mkha' 'gro'i gsung 'bum", '/',
                ...
                [ { ver, 'W1PD108254', "I1PD108256-I1PD108261" } ] },

        { pub,  'Tutop Lingpa Tercho', 10, "mthu stobs gling pa'i gter chos", '/',
        ...
        { pub,  'Nyingma Kama', 58, "rnying ma bka' ma rgyas pa", '/',
                ...
                "tradition in the 7th century was that of the brothers of Mindroling, Terdag Lingpa"
                "(1646-1714) and Minling Lochen Dharmashri (1654-1718). The actual compilation work was"
        ...
        { pub,  'Nyang Ral Nyima Ozer Kagye', 13, "bka' brgyad bde gshegs 'dus pa", '/',
        ...
        { pub,  'Guru Chowang Kagye', 4, "bka' brgyad gsang ba yongs rdzogs", '/',
                ...
                [ { ver, 'W23819', "2833-2836" } ] },

        { pub,  'Sangye Lingpa Lama Gondu', 18, "bla ma dgongs 'dus", '/',
        ...
        { cat,  "klong chen pa'i gsung skor",
                ...
                { pub,  'Longchenpa Nyingthig Yabzhi', 13, "snying thig ya bzhi", '/',
                        ...
                        [ { ver, 'W12827', "2061-2073" } ] },

                { pub,  'Longchenpa Ngalso Korsum', 3, "ngal gso skor gsum sogs", '/',
                        ...
                        [ { ver, 'W23760', "2628-2630" } ] },

                { pub,  'Longchenpa Sungthorbu', 2, "klong chen pa'i gsung thor bu", '/',
                        ...
                        [ { ver, 'W23504', "2074-2075" },
                          { ver, 'W23555', "2130-2131" } ] } ] },
        ...
        { pub,  'Padma Lingpa Tercho', 21, "padma gling pa'i chos skor", '/',
                ...
                [ { ver, 'W21727', "1905-1925" } ] },

        { pub,  'Jigme Lingpa Sungbum', 14, "'jigs med gling pa'i gsung 'bum", '/',
        ...
        { pub,  'Dorje Lingpa Tercho', 4, "rdo rje gling pa'i gter chos", '/',
        ...
        { pub,  'Ratna Lingpa', 20, "ratna gling pa'i gter chos (dpal yul lugs)", '/',
                ...
                [ { ver, 'W3PD1003', "I3PD1102-I3PD1120" },
                  { ver, ['W21731-W21741', 'W23823-W23826'], "" } ] },

        { pub,  'Peyul Ganesh', 2, "mgon po tshogs bdag glang sna'i sgrub skor", '/',
                "Rituals for the propitiation of Ganesh as a protective deity according to Peyul Monastery.",
                [ { ver, 'W21950', "3897-3898" } ] },

        { pub,  'Diri Chodrak Ganapati', 1, "mgon po tshogs bdag gi gsang sgrub dngos grub 'byung gter", '/',
                "Practice text for the secret sadhana of Ganapati according to revelations by Diri Chodrak.",
                [ { ver, 'W25816', "3899" } ] },

        { pub,  'Ganapati', 1, "mgon po tshogs bdag gi sgrub skor", '/',
                "Nyingma rituals for the propitiation of Ganapati and other"
                "protective deites of the Nyingma order.",
                [ { ver, 'W25817', "3896" } ] },


        { pub,  'Mipham Sungbum', 27, "mi pham rgya mtsho'i gsung 'bum", '/',
                ...
                [ { ver, 'W23468', "2004-2030" } ] },

        { pub,  'Lhatsun Namka Jigme', 4, "lha btsun nam mkha' 'jigs med", '/',
                ...
                [ { ver, 'W20865', "174-177" },
                  { ver, 'W1KG3654', "I1KG4573-I1KG4576" } ] },

        { pub,  'Lhatsun Namka Jigme Rigdzin Sodrub', 5, "rig 'dzin srog sgrub", '/',
        ...
        { pub,  'Tsele Natsog Rangdrol', 8, "rtse le sna tshogs rang grol", '/',
                ...
                [ { ver, 'W21019', "2487-2494" } ] },

        { pub,  'Dudul Dorje Zater', 12, "spo bo gter chen bdud 'dul rdo rje", '/',
        ...
        { pub,  'Longsal Nyingpo', 12, "klong gsal snying po", '/',
        ...
        { pub,  'Terdak Lingpa', 16, "gter bdag gling pa 'gyur med rdo rje", '/',
                ...
                [ { ver, 'W22096', "2195-2210" } ] },

        { pub,  'Lochen Dharma Shri', 20, "smin gling lo chen dharma shrI", '/',
        ...
        { pub,  'Tsasum Yidam Gondu', 19, "rtsa gsum yi dam dgongs 'dus", '/',
                ...
                [ { ver, 'W21974', "3064-3082" } ] },

        { pub,  'Terdag Lingpa Guhyajnana', 16, "mkha' 'gro gsang ba ye shes kyi chos skor", '/',
        ...
        { pub,  'Kathok Rigdzin Tsewang Norbu', 4, "kaH thog rig 'dzin tshe dbang nor bu", '/',
        ...
        { pub,  'Gyalse Shenpen Thaye', 2, "rdzogs chen rgyal sras gzhan phan mtha' yas", '/',
                ...
                [ { ver, 'W20338', "2850-2851" } ] },

        { pub,  'Dza Patrul Rinpoche', 5, "rdza dpal sprul o rgyan 'jigs med chos kyi dbang po", '/',
        ...
        { pub,  'Mipam Gyatso Songs', 1, "'phags yul grub dbang dam pa rnams kyi zab mo'i do ha rnams las khol byung mu tig phreng ba", '/',
                "Collection of doha or songs of esoteric practice of Indian Mahasiddhas;"
                "compiled by Mipam Gyatso (1846-1912)",
                [ { ver, 'W19230', "1656" } ] },

        { pub,  'Jomo Menmo', 1, "mkha' 'gro gsang ba kun 'dus kyi chos skor", '/',
        ...
        { pub,  'Dudjom Lingpa Tercho', 20, "bdud 'joms gling pa", '/',
        ...
        { pub,  'Dodrubchen 3 Jigme Tenpai Nyima', 5, "rdo grub chen 'jigs med bstan pa'i nyi ma", '/',
                ...
                [ { ver, 'W23627', "2802-2806" } ] },

        { pub,  'Dujom Dragngag Lingpa', 8, "bdud 'joms drag sngags gling pa", '/',
        ...
        { pub,  'Khenpo Kunga Palden', 2, "mkhan po kun dga' dpal ldan", '/',
                "Collection writings of a late 19th century scholar of the Mipham tradition.",
                [ { ver, 'W23946', "3551-3552" } ] },

        { pub,  'Nam Cho', 13, "gnam chos", '/',
...
{ cat, "RIME", "", '/', [
        ...
        { pub,  'Choklin Tersar', 39, "mchog 'gyur gling pa'i gter gsar", '/',
                ...
                [ { ver, 'W22642', "0534-0572" } ] },

        { pub,  'Dilgo Kyentse Rabsal Dawa', 25, "dil mgo mkhyen brtse rab gsal zla ba", '/',
        ...
        { pub,  'Dzongsar Kyentse Jamyang Chokyi Lodro', 10, "'jam dbyangs mkhyen brtse chos kyi blo gros", '/',
                ...
                [ { ver, 'W21813', "415-422" },
                  { ver, 'W21814', "3564-3565" } ] },

        { pub,  'Jamgon Kongtrul Dam Ngag Dzo', 18, "gdams ngag mdzod", '/',
...
{cat, "GELUG", "", '/', [
        ...
        { pub,  'Kadam Chojung', 2, "bka' gdams chos 'byung gsal ba'i sgron me", '/',
                ...
                [ { ver, 'W15964', "2499-2500" } ] },

        { pub,  '', 1, "blo sbyong glegs bam", '/',
        ...
        { pub,  '', 1, "lho brag grub chen nam mkha' rgyal mtshan", '/',
        ...
        { pub,  '', 27, "tsong kha pa blo bzang grags pa (bkras lhun par rnying)", '/',
                ...
                [ { ver, 'W22109', "3105-3131" } ] },

        { pub,  '', 12, "paN chen bsod nams grags pa", '/',
                ...
                "is used to this day.",
                [ { ver, 'W23828', "3696-3707" } ] },

        { pub, '', 2, "a kyA blo bzang bstan pa'i rgyal mtshan", '/',
                ...
                [ { ver, 'W22352', "2507-2508" } ] },

        { pub,  '', 2, "rnga rgod nam mkha' sengge", '/',
                "The collected writings of a Gelug teacher from Amdo,"
                "Ngago Namka Sengge (1712-1780).",
                [ { ver, 'W11818', "3639-3640" } ] },

        { pub,  '', 25, "tshe mchog gling yongs 'dzin ye shes rgyal mtshan", '/',
        ...
        { pub,  '', 13, "paN chen blo bzang dpal ldan ye shes", '/',
        ...
        { pub,  '', 10, "cha har dge bshes blo bzang tshul khrims", '/',
                ...
                [ { ver, 'W23726',   "2509-2518" } ] },

        { pub,  '', 4, "rwa sgreng khri sprul blo bzang ye shes bstan pa rab rgyas", '/',
        ...
        { pub,  '', 6, "rgyal mkhan chen grags pa rgyal mtshan", '/',
                ...
                [ { ver, 'W22117', "2501-2506" } ] },

        { pub,  '', 8, "gung thang dkon mchog bstan pa'i sgron me", '/',
                ...
                [ { ver, 'W22112'      ,"0726-0733" } ] },

        { pub,  '', 2, "gsung 'bum / blo bzang 'jam dbyangs smon lam", '/',
                "The collected works (gsung 'bum) of the 18th century Gelug"
                "master Keutsang Lozang Jamyang Monlam",
                [ { ver, 'W16515',            "3891- 3892" } ] },

        { pub,  '', 8, "lcang lung ngag dbang bstan pa'i rgyal mtshan", '/',
        ...
        { pub,  '', 8, "dngul chu dharma bhadra", '/',
                ...
                [ { ver, 'W20548',          "1304-1311" } ] },

        { pub,  '', 21, "khal kha brag ri dam tshig rdo rje", '/',
        ...
        { pub,  '', 9, "paN chen bstan pa'i nyi ma phyogs las rnam rgyal", '/',
        ...
        { pub,  '', 7, "khu re mkhan po ngag dbang dpal ldan", '/',
        ...
        { pub,  '', 7, "a khu ching shes rab rgya mtsho", '/',
                ...
                [ { ver, 'W21505', "2519-2525" } ] },

        { pub,  '', 3, "dngul chu dbyangs can grub pa'i rdo rje", '/',
                ...
                [ { ver, 'W22334', "3865-3867" } ] },

        { pub,  '', 4, "zhang ston bstan pa rgya mtsho", '/',
                ...
                [ { ver, 'W22145', "3839-3842" } ] },

        { pub,  '', 3, "paN chen bstan pa'i dbang phyug", '/',
        ...
        { pub,  '', 3, "rong tha che tshang blo bzang chos 'byor lhun grub", '/',
                "Collected writings of Rongta Lozang Chojor Lhundrub (1857-1900/1901),"
                "a Gelug teacher from Ranyag Monastery in Kham.",
                [ { ver, 'W21027', "3039-3041" } ] },

        { pub,  '', 6, "rong tha chung tshang blo bzang dam chos rgya mtsho", '/',
                ...
                [ { ver, 'W13528', "3099-3104" } ] },

        { pub,  '', 20, "brag dkar blo bzang dpal ldan bstan 'dzin snyan grags", '/',
                ...
                [ { ver, 'W23608', "3231-3250" } ] },

        { pub,  '', 17, "rtsa ba blo bzang rta mgrin", '/', 
                ...
                [ { ver, 'W13536', "3679-3695" } ] },

        { pub,  '', 6, "paN chen thub bstan chos kyi nyi ma", '/',
        ...
        { pub,  '', 3, "rdo sbis dge bshes shes rab rgya mtsho", '/',
                "Collected writings of Dowi Geshe Sherab Gyatso (1884-1968).",
                [ { ver, 'W24765', "3848-3850" } ] },

        { pub,  '', 6, "sog po dge bshes ngag dbang nyi ma", '/',
                ...
                [ { ver, 'W24052', "3821-3826" } ] },

        { pub,  '', 1, "gsang sngags rdo rje theg pa'i rnam gzhag rig 'dzin dga' ston", '/',
        ...
        { pub,  '', 43, "rje yab sras gsum gyi gsung 'bum", '/',
        ...
        { pub,  '', 5, "dalai lama 1 dge 'dun grub kyi gsung 'bum", '/',
        ...
        { pub,  '', 13, "dalai Lama 7 blo bzang bskal bzang rgya mtsho'i gsung 'bum", '/',
                ...
                [ { ver, 'W2623', "     1295-1303, 2333-2336" } ] },

        { pub,  '', 15, "'jam dbyangs bzhad pa'i rdo rje'i gsung 'bum", '/',
                ...
                [ { ver, 'W21503', "0399-0414" } ] },

        { pub,  '', 12, "rong chen kirti blo bzang 'phrin las kyi gsung 'bum", '/',
...
{ cat, "SAKYA", "", '/', [
        ...
        { pub,  '', 18, "sa skya bka' 'bum + kha skong", '/',
                ...
                [ { ver, 'W22271',   "762-776" },
                  { ver, 'W20751',  "1720-1722" } ] },

        { pub,  '', 4, "ngor chen gyi bka' 'bum", '/',
                ...
                [ { ver, 'W11577', "2400-2403" } ] },

        { pub,  '', 17, "go rams pa'i gsung 'bum + kha skong", '/',
                ...
                [ { ver, 'W11249', "0431-0443" },
                  { ver, 'W19604', "0444" },
                  { ver, 'W23205', "0445" },
                  { ver, 'W19605', "0446" },
                  { ver, 'W19606', "0447" } ] },

        { pub,  '', 24, "shakya mchog ldan gyi gsung 'bum", '/',
                ...
                [ { ver, 'W23200', "0808-0831" } ] },

        { pub,  '', 10, "zhu chen tshul khrims rin chen gyi gsung 'bum", '/',
                ...
                "blocks in India.",
                [ { ver, 'W10347', "2902-2908" },
                  { ver, 'W23862',  "2928" },
                  { ver, 'W23863', "2929-2930" } ] },

        { pub,  '', 6, "na ro mkha' spyod ma'i chos skor", '/',
                "Collected teachings of the Sakya tradition for the practice of Vajrayogini.",
                [ { ver, 'W23650', "2367-2372" } ] },

        { pub,  '', 14, "sgrub thabs kun btus", '/',
                ...
                "blockprints.",
                [ { ver, 'W23681',   "2416-2428, 2475" } ] },

        { pub,  '', 21, "lam 'bras slob bshad", '/',
                ...
                "tradition. This collection was originally carved on to blocks at the Derge Parkang in Kham.",
                [ { ver, 'W23649', " 2346-2366" } ] },

        { pub,  '', 6, "lam 'bras tshogs bshad", '/',
                "The Lamdre Tsogche collection is the presentation of the Lamdre followed by the"
                "Ngorpa subsect of the Sakya.",
                [ { ver, 'W23648', "2340-2345" } ] },

        { pub,  '', 28, "bu ston rin chen grub dang sgra tshad pa rin chen rnam rgyal", '/',
...
{ cat, "MARPA KAGYU", "", '/', [
        ...
        { pub,  '', 6, "dpal 'brug pa'i lugs kyi dbang chog 'dod rgu'i bang mdzod", '/',
                ...
                [ { ver, 'W19223', "4159-4164" } ] },

        { pub,  '', 3, "dkar brgyud gser phreng", '/',
                ...
                [ { ver, 'W23861',      "3000-3002" } ] },

        { pub,  '', 4, "rwa lung gser 'phreng", '/',
                ...
                [ { ver, 'W19222', "3194-3197" } ] },

        { pub,  'Bara Kagyu Serteng', 4, "'ba' ra dkar brgyud gser 'phreng", '/',
                ...
                [ { ver, 'W19231',      "1743-1746" } ] },

        { pub,  'Bara Kagyu Chocho', 1, "'ba' ra bka' brgyud chos spyod", '/',
        ...
        { pub,  '', 4, "zhwa dmar mkha' spyod dbang po", '/',
                ...
                [ { ver, 'W23928', "3568-3571" } ] },

        { pub,  '', 2, "zhwa dmar dkon mchog yan lag", '/',
                "Collection of writings by the 5th Shamar Konchog Yanlag (1525-1583).",
                [ { ver, 'W23927', "3572-3573" } ] },

        { pub,  '', 4, "rnal 'byor rgyud kyi rnam bshad sogs / karma pa mi bskyod rdo rje", '/',
                "Exegesis of the yogatantra and other works by the 8th Karmapa Mikyo Dorje (1507-1554)",
                [ { ver, 'W22141',      "1657-1660" } ] },

        { pub,  '', 14, "nges don phyag rgya chen po'i khrid mdzod dang dkar chag", '/',
                "Collected instructions on the practice of the Mahamudra according to the Kagyu traditions.",
                [ { ver, 'W23447', "1891-1903" },
                  { ver, 'W23701', "1904    (dkar chag)" } ] },

        { pub,  '', 1, "byang chub sems dpa'i spyod pa la 'jug pa'i rnam par bshad pa theg chen chos kyi rgya mtsho zab rgyas mtha' yas pa'i snying po", '/',
        ...
        { pub,  '', 1, "zab mo nang don zhes bya ba'i gzhung", '/',
                "Verse work on tantric anatomy and physiology written by"
                "the Third Karmapa Ranjung Dorje (1284-1339).",
                [ { ver, 'W679', "1701" } ] },

        { pub,  '', 1, "dpal rdo rje'i tshig zab mo nan gi don gyi 'grel bsad sems kyi rnam par gsal bar byed pa'i rgyan", '/',
        ...
        { pub,  '', 4, "gshin rje gshed yang bzlog me'i spu gri", '/',
        ...
        { pub,  '', 2, "'bri gung bka' brgyud pa'i chos skor", '/',
                "Collection of rare Drigung Kagyu texts.",
                [ { ver, 'W23189', "586-587" } ] },

        { pub,  '', 8, "rig 'dzin nus ldan rdo rje", '/',
                "Collected writings of a 19th century terton of"
                "the Drigung Kagyu tradition, Rigdzin Nuden Dorje",
                [ { ver, 'W23653', "2377-2384" } ] },

        { pub,  '', 2, "snyan rgyud rdo rje'i tshig rkang gi 'brel zab lam chu bo kun 'dus nor bu'i 'byung gnas", '/',
                "Taglung Kagyu commentary on the Six Teachings of Naropa by Ngawang Tenpai Nyima (b. 1788)",
                [ { ver, 'W21550',      "387-388" } ] },

        { pub,  '', 1, "phyag chen dang nA ro chos drug gi khrid skor stag lung lugs", '/',
        ...
        { pub,  '', 1, "stag lung rje gnang bzhi bcu zhe gsum", '/',
        ...
        { pub,  '', 4, "karma mkhan po karma rin chen dar rgyas", '/',
        ...
        { pub,  '', 31, "rtsib ri par ma", '/',
                ...
                [ { ver, 'W20749', "1264-1294" } ] },

        { pub,  '', 4, "sgam po pa'i gsung 'bum", '/',
                ...
                [ { ver, 'W23439', "1747-1750" } ] },

        { pub,  '', 9, "phag mo gru pa'i gsung 'bum", '/',
                "Pagmo Drupa Dorje Gyalpo (1110-1170) was a direct disciple of Gampopa"
                "Sonam Rinchen (1079-1153) and the progenitor of the eight 'Lesser of the Marpa Kagyu Schools'.",
                [ { ver, 'W23891',  "3165-3173" } ] },

        { pub,  '', 5, "bla ma zhang gi bka' 'bum", '/',
                ...
                [ { ver, 'W13994', "3025-3029" } ] },

        { pub,  '', 24, "kun mkhyen padma dkar po'i gsung 'bum", '/',
                ...
                [ { ver, 'W10736', "1240-1263" } ] },

        { pub,  '', 15, "rig 'dzin chos kyi grags pa'i gsung 'bum", '/',
                ...
                [ { ver, 'W22082',   "2180-2194" } ] },

        { pub,  '', 10, "karma pa mkha' khyab rdo rje'i gsung 'bum", '/',
                ...
                [ { ver, 'W22081',   "0359-0368" } ] },

        { pub,  '', 8, "mkhas dbang sangs rgyas rdo rje", '/',
                ...
                [ { ver, 'W23556', "2132-2139" } ] },

        { pub,  'Shakya Shri', 1, "shAkya shrI", '/',
...
{ cat, "SHANGPA KAGYU", "", '/', [
        ...
        { pub,  '', 1, "sans pa bka' brgyud pa'i khrid skor than rgyal lugs", '/',
        ...
        { pub,  '', 3, "thang stong rgyal po'i bka' 'bum", '/',
...
{ cat, "JONANG", "", '/', [
        ...
        { pub,  '', 8, "kun mkhyen dol po pa shes rab rgyal mtshan", '/',
                ...
                [ { ver, 'W21208', "3492-3499" } ] },

        { pub,  '', 23, "rje btsun ta ra na tha'i gsung 'bum ('dzam thang)", '/',
                ...
                "Puntsoling edition.",
                [ { ver, 'W22276', "1680, 2255-2257, 2291, 2295-2311, 3527" } ] },

        { pub,  '', 17, "jo nang rje btsun tA ra nA tha", '/',
